...
export function ProductSection({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex h-full max-w-6xl flex-col justify-start pt-24 gap-10 md:flex-row md:items-center md:gap-16">
        <motion.div
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-6">
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-xl font-medium text-auram-gold">
                {price}
              </span>
            </div>

            <button className="relative overflow-hidden rounded-full border border-auram-bronze px-6 py-3 text-xs font-medium uppercase tracking-[0.25em] text-auram-white/90 transition-all duration-300 bg-gradient-to-r from-auram-gold to-[#F9E076] hover:brightness-110 hover:shadow-auram-glow">
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <div className="relative mx-auto aspect-square max-w-[320px] overflow-hidden rounded-[32px] border border-auram-gold/20 shadow-auram-glow md:max-w-sm">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(212,175,55,0.15),_transparent_70%)]" />
            <Image
              src={image}
              alt={label}
              fill
              className="relative z-10 p-6 object-contain"
